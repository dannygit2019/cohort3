import { City, Community, functions } from './CommunityPOJO'
...
//     expect(functions.deleteCurrentCard(newParent, newCard)).toEqual(1);// expect(functions.deleteCurrentCard(newParent, newCard)).toEqual(5);
// });
